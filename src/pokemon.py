...
class AtaqueInvalidoError(ValueError):
    ...
    def __str__(self) -> str:
        """Devuelve un mensaje de error para ataque inválido."""
...
class SaludInvalidaError(ValueError):
    ...
    def __str__(self) -> str:
        """Devuelve un mensaje de error para salud inválida."""
...
class Pokemon:
    ...
    def calcular_power_contra(self, otro_pokemon: "Pokemon") -> float:
        """Calcula el poder total de ataque contra otro Pokémon."""
    ...
    def battle(self, otro_pokemon: "Pokemon") -> str:
        """Simula un combate entre dos Pokémon y devuelve el ganador."""
